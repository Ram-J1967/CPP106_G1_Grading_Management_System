...
public class Main extends javax.swing.JFrame {
   ...
   String firstName = Firstname.getText().trim();
    ...
    // Check if grades are values from 0-100
    if (isGradeValid(prelim_grade) && isGradeValid(midterm_grade) && isGradeValid(final_grade)) {
        ...
        JOptionPane.showMessageDialog(this, "Grades must be numeric and between 0 and 100!", "Invalid Grade", JOptionPane.WARNING_MESSAGE);
    }
}

/// Check if grades is between 0-100
